...
def chips_html() -> str:
    ...
    (ไม่มีทางขึ้น "0 เครื่อง" เพราะคนที่กำลังเปิดหน้าอยู่ก็ถูกนับด้วยแล้ว)
    ...
    if _total <= 0:
        return ''
    return ('<span class="or-chip" style="background:#1b7f4b;color:#ffffff;'
            f'border-color:#1b7f4b;font-weight:700;">🟢 ออนไลน์ {_total} เครื่อง</span>')
