...
def _board_fragment():
    ...
    with st.expander("❓ วิธีใช้บอร์ดตารางผ่าตัด", expanded=False):
        st.markdown(
            ...
            "1. **ระดับความมั่นใจ (สูง/ปานกลาง/ต่ำ)**"
            "ประเมินจากความคุ้นเคยของแบบจำลองต่อข้อมูลนำเข้า 3 องค์ประกอบ ได้แก่ "
            "หัตถการ · ศัลยแพทย์ · กลุ่มหัตถการ — *สูง* = แบบจำลองรู้จักครบทั้งสามองค์ประกอบ "
            " · *ปานกลาง* = รู้จัก 2 ใน 3 · *ต่ำ* = รู้จักน้อยกว่า 1 องค์ประกอบ "
