...
def _board_fragment():
    ...
    with st.expander("❓ วิธีใช้บอร์ดตารางผ่าตัด", expanded=False):
        st.markdown(
            ...
            "---\n"
            "**ระดับความมั่นใจของการทำนาย (คำอธิบายเชิงวิชาการ)**\n\n"
            "ระบบรายงานความไม่แน่นอนของการทำนาย 3 ชั้น ดังนี้\n\n"
            "1. **ระดับความมั่นใจ (สูง/ปานกลาง/ต่ำ)** — ดัชนีเชิงคุณภาพ (heuristic) "
            "ประเมินจากความคุ้นเคยของแบบจำลองต่อข้อมูลนำเข้า 3 องค์ประกอบ: "
            "หัตถการ · ศัลยแพทย์ · กลุ่มหัตถการ — *สูง* = แบบจำลองรู้จักครบทั้งสาม "
            "(รวมหัตถการ) · *ปานกลาง* = รู้จัก 2 ใน 3 · *ต่ำ* = รู้จักน้อยกว่านั้น "
            "(การทำนายอิงค่ากลางเป็นหลัก ควรใช้วิจารณญาณประกอบ)\n"
            "2. **จำนวนเคสอ้างอิง (จาก N เคส)** — จำนวนเคสของหัตถการนั้น"
            "ในข้อมูลที่ใช้พัฒนาแบบจำลอง (พ.ศ. 2564–2566) สะท้อนความหนาแน่น"
            "ของหลักฐานเชิงประจักษ์\n"
            "3. **ช่วงเวลาที่คาดการณ์** — แสดง 2 ระดับ: (ก) ช่วงบนบอร์ด "
            "(เช่น ออกห้อง ~10:20–11:20) เป็นช่วงเชิงปฏิบัติการ ปรับความกว้างตาม"
            "ความยาวเคส คาลิเบรตจากข้อมูลจริง เหมาะสำหรับวางแผนหน้างาน · "
            "(ข) ช่วงความเชื่อมั่น 90% ในปุ่ม ✏️ คำนวณด้วยวิธี split conformal "
            "prediction ซึ่งมีหลักประกันความครอบคลุมเชิงทฤษฎี (ครอบคลุมเวลาจริง"
            "ประมาณ 9 ใน 10 เคส) — ช่วงนี้กว้างกว่าโดยธรรมชาติ เพราะสะท้อน"
            "ความแปรปรวนจริงของเวลาผ่าตัดรวมถึงเหตุไม่คาดฝัน\n\n"
            "ข้อพึงระวัง: ระดับความมั่นใจเป็นดัชนีเชิงคุณภาพ มิใช่ค่าความน่าจะเป็น"
            "ทางสถิติ — ค่าที่มีหลักประกันทางสถิติคือช่วง 90% ในข้อ 3(ข) · "
            "ในทุกกรณี พยาบาลสามารถปรับเวลาทับค่าทำนายได้เสมอ (✏️) "
