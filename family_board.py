...
หลักการ:
  ...
  - 🔢 รหัสรับบริการ (fam_code): แทน HN บนจอนี้ทั้งหมด — สุ่มต่อเคส ไม่โยงกับ HN จริง
"""
import html
import json
...
def _card(c) -> str:
    ...
    รหัสรับบริการ (fam_code) แทน HN เดิม — สุ่มต่อเคส เดา HN จริงไม่ได้"""
    ...
    #    ใช้ "รหัสรับบริการ" แทนทั้งหมด — เจ้าหน้าที่เป็นผู้แจ้งรหัสให้ญาติที่จุดรับ-ส่ง
...
def render_family_board():
    ...
    st.markdown(
        ...
        'แสดงชื่อย่อและรหัสรับบริการ (สุ่ม ไม่ใช่ HN จริง) เพื่อคุ้มครองข้อมูลส่วนบุคคล · '
